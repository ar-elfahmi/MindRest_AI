# 17 — Migrate ReminderScreen to Design Tokens

**Wave:** 5 · **Effort:** M ~1.5h · **Status:** ⬜ todo
**File:** `app/src/main/java/com/example/features/reminder/presentation/screen/ReminderScreen.kt`
**LOC:** 497 · **Hardcoded dp:** 24 · **Hardcoded sp:** 0 · **Hardcoded hex:** 0
...
- Tidak baca dari DB (mock, biarkan). 4 cards -> AppCard. 6 Column. Time picker styling -> token.
...
- Setelah selesai: update status board (`README.md` 17 -> ✅), commit `refactor(ui): migrate ReminderScreen to design tokens`.
