# 12 — Migrate IkigaiAssessmentScreen to Design Tokens

**Wave:** 4 · **Effort:** M ~1h · **Status:** ⬜ todo
**File:** `app/src/main/java/com/example/features/ikigai/presentation/screen/IkigaiAssessmentScreen.kt`
**LOC:** 323 · **Hardcoded dp:** 19 · **Hardcoded sp:** 0 · **Hardcoded hex:** 0
...
- 6 pertanyaan assessment (form). Progress indicator -> spacing token. Radio/pilihan -> AppCard(Outlined) atau AppChip.
...
- Setelah selesai: update status board (`README.md` 12 -> ✅), commit `refactor(ui): migrate IkigaiAssessmentScreen to design tokens`.
